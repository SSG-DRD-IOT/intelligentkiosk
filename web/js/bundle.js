...
var awsConfiguration = {
   poolId: 'us-east-1:c7a88309-c557-4790-a348-5ea13eee9e1c', // 'YourCognitoIdentityPoolId'
   host: 'a1lbizsabp5xcz.iot.us-east-1.amazonaws.com', // 'YourAwsIoTEndpoint', e.g. 'prefix.iot.us-east-1.amazonaws.com'
...
window.mqttClientMessageHandler = function(topic, payload) {
   ...
   ipcRenderer.send('alexakeyword', payload.toString());
...
window.updateSubscriptionTopic = function() {
   var subscribeTopic = 'TestGroup1_Core-policy';
