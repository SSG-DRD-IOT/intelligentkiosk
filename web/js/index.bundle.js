...
const avs = new AVS({
  debug: true,
  clientId: 'amzn1.application-oa2-client.3dbbc7e929f74fdcbecd5132ed95eac6',
  clientSecret:'5df8e12f35413f4a2fa605c3679175ded135d57ba8163c3ff702350f47da5668',
  deviceId: 'my_products',
...
function login(event) {
  ...
  // If using client secret
  return avs.login({responseType: 'code'})
  .then(() => avs.requestMic())
  .catch(() => {});
